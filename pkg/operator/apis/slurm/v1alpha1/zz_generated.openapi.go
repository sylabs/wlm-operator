...
func schema_operator_apis_slurm_v1alpha1_SlurmJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_operator_apis_slurm_v1alpha1_SlurmJobResults(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_operator_apis_slurm_v1alpha1_SlurmJobStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
